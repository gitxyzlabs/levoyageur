...
import { Award, Users, Star, ChevronLeft, ChevronRight, MapPin, Edit3, Navigation, Heart, Bookmark, Calendar, Share2 } from 'lucide-react';
        ...
        <div className="flex items-start justify-between mb-3 px-4 pt-4 sticky top-0 bg-white z-10">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Share"
            >
              <Share2 className="w-4 h-4 stroke-gray-600" />
            </button>
