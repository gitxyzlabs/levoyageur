...
import { User as UserIcon, Mail, Shield, Calendar, MapPin, Star } from 'lucide-react';
          ...
          <CardContent>
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
              <p className="text-xs text-amber-800">
                <strong>Temporarily disabled.</strong> This feature is being rebuilt and isn't available right now.
              </p>
            </div>
          </CardContent>
        </Card>
